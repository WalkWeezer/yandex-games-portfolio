...
window.PITCH_TACTICS_MATCHES = [
  {
    id: "H",
    title: "Блок → прессинг",
    subtitle: "Оба начинают осторожно. Сон на чужих ОП → гол. B раскрывается.",
    scoreFinal: "1:1",
    styles: { A: "Низкий контроль", B: "Пассивный блок → прессинг" },
    uiGlossary: [
    ...
    steps: [
      {
        ...
        narrative: "Свисток. Мяч в центре. Оба тренера задумали играть от обороны — это их выбор, не скрипт.",
        ball: [5, 9],
        players: {
          A: { GK:[5,1], Z:[5,4], OP1:[3,6], OP2:[7,6], NAP:[5,8] },
...

  {
    id: "I",
    title: "Контроль → край",
    subtitle: "A тики-така, B активный блок. Замах читают — A уходит на фланг. Обмен голами.",
    scoreFinal: "1:1",
    styles: { A: "Контроль → фланг", B: "Активный блок → контра" },
    uiGlossary: [
    ...
    steps: [
      {
        min: 0, side: "kick", score: [0, 0],
        narrative: "Kick-off A. B заранее готов переставлять Defend — не мёртвый блок.",
        ball: [5, 9],
        players: {
          A: { GK:[5,1], Z:[5,4], OP1:[3,6], OP2:[7,6], NAP:[5,8] },
          B: { GK:[5,18], Z:[5,15], OP1:[3,13], OP2:[7,13], NAP:[5,11] }
        ...
        actions: [],
        roll: null,
        uiLabels: [{ id: "banner", text: "Kick-off A" }]
      },
      {
        min: 2, side: "B", score: [0, 0], ap: 2,
        ...
        ball: [5, 10],
        players: {
          A: { GK:[5,1], Z:[5,5], OP1:[4,9], OP2:[7,9], NAP:[5,10] },
          B: { GK:[5,18], Z:[5,14], OP1:[4,13], OP2:[7,13], NAP:[5,11] }
        },
        statuses: { "B.Z": { defend: 2 } },
        focus: { "B.NAP": 1 },
...

  {
    ...
    subtitle: "A прессит, забивает, уходит в автобус. B обязан раскрыться. Замах добивает.",
    scoreFinal: "2:0",
    styles: { A: "Пресс → блок", B: "От обороны → вынужденный риск" },
    uiGlossary: [
    ...
    steps: [
      {
        min: 0, side: "kick", score: [0, 0],
        narrative: "A сразу высокий прессинг. B хочет низкий блок — законный план.",
        ball: [5, 9],
        players: {
          A: { GK:[5,1], Z:[5,5], OP1:[3,9], OP2:[7,9], NAP:[5,10] },
          B: { GK:[5,18], Z:[5,15], OP1:[3,13], OP2:[7,13], NAP:[5,11] }
        },
        statuses: {},
        focus: {},
        actions: [],
        roll: null,
        uiLabels: [{ id: "banner", text: "Прессинг A с первой минуты" }]
      },
      {
        min: 3, side: "A", score: [0, 0], ap: 2,
