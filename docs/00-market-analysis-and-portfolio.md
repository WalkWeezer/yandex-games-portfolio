...
| 4 | **Живи Футболом** | Online football manager (SoccerLife × FM-lite) | D | P1 (высокий LTV) | hybrid VIP + convenience |
...
7. **Живи Футболом** (замена «Легенд Поля») — см. ниже.

### Идея футбольного менеджера: имеет ли смысл?

**Да — как компоновка готовых кусков, не как новый гибрид-жанр.**  
«Легенды Поля» (CCG × autochess × менеджмент) сняты: механика не формулируется.  
Вместо них — **Живи Футболом**: оболочка SoccerLife + матч/тактика FM-lite + live-control.

- **Хаб / сезон / трансферы / здания** → daily return и VIP (как SoccerLife / Top Eleven).
- **Формация + роли + инструкции + отчёт** → глубина FM без Excel.
- **2–3 live-решения в матче** → USP SoccerLife, отличие от чистого автосима.
- **LiveOps** — сезоны, таблица, лидерборды Яндекса.

**Риски:** стоимость матч-движка и контента базы; перегруз UI.  
**Решение:** событийный матч (не физика FIFA); ≤5 вкладок хаба; без реальных лицензий в MVP; без карт/гачи.

Полный концепт — в `docs/concepts/04-soccer-life.md`.
