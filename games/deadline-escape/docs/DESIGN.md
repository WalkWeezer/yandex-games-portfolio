...
| Сетка база | **6×8** play (+fog 1); рост: каждые **25** этажей +1 col **или** +1 row |
...
- Play-зона база **6×8** (+рост); с каждой стороны всегда **+1** клетка **полосы тумана** (только вход/выход мобов, не walk).
