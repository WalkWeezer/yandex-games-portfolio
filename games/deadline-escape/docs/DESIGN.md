...
- **Туман войны:** сильный градиент на **открытых** клетках полосы (снаружи ≈чёрный → к play alpha 0). Рисуется поверх сущностей — спавн читается силуэтом. **Клетки со стеной/окном без FoW-градиента.**
