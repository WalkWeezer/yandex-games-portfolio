...
> Обновлено 2026-07-20. SoT: `management/demos/legends-pitch-demo.js` → `FEEL_DEMOS["legends-of-the-pitch"]`.  
> **Ключ:** карта = **1 амплуа + 1 тактика**; тактики TFT ×2/×3; **вся сетка 3×5** для позиций обеих команд; матч top-down, мяч летит, FX на отбор/пас/удар/сейв.

| Поле | Значение |
|------|----------|
| **Core verb** | Собери тактику из амплуа → стекни ★ в магазине → **смотри матч** |
| **Пространство** | Сетка 3×5 top-down; 5v5; кружки с «ручками»; **позиции по всей сетке** (свои и соперник пересекаются) |
| **Win** | Больше голов после 7 сегментов |
| **Fail** | Меньше голов к финалу |
| **Ввод** | Состав (карта→клетка) → магазин (витрина 3, скамейка 2, merge 3→★) → автобой; ×2 |
| **Анти-вектор** | Абстрактные теги без матча; телепорт мяча; FM-Excel; физика 11v11 |

### Карта и комбо (ядро)

| Ось | Что это | Пример |
|-----|---------|--------|
| **Позиция** | клетка сетки + зона роли | GK / DEF / MID / WING / FWD |
| **Амплуа** | лицо карты (1) → веса действий | BWM, Poacher, Winger, ShotStop… |
| **Тактика** | TFT-трейт на карте (1) | Gegenpress, Tiki-Taka, Park Bus, Counter, Wing Play |

**Тактика включается набором на поле** (не меню): ×2 слабый стиль, ×3 полный, ×4 слом.  
Матч: пас/навес/отбор/перехват/удар/сейв с паузой на момент; мяч перемещается, не телепортируется.

| Число | Значение |
|-------|----------|
| Формат | **5v5**; колода 12; витрина 3; скамейка 2; merge 3→★ |
| Оси на карте | амплуа · тактика · ★ · COST |
| Комбо | тактики ×2/×3/×4 |
