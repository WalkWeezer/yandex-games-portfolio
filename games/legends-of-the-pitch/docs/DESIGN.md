...
> **2026-07-20: код демки удалён.** Писать с нуля по  
> `management/demos/PROMPT_LEGENDS_PITCH_SCRATCH.md`.  
> Не восстанавливать старый `legends-pitch-demo.js` из history.

| Поле | Значение |
|------|----------|
| **Core verb** | Собери тактику из амплуа → стекни ★ в магазине → **смотри матч** |
| **Пространство** | Сетка 3×5 top-down; **6v6**; кружки с «ручками»; **вся сетка** для обеих команд |
| **Win** | Больше голов после 7 сегментов |
| **Fail** | Меньше голов к финалу |
| **Ввод** | Состав (карта→любая клетка) → магазин → автобой; ×2 |
| **Анти-вектор** | Старый код демки; телепорт мяча; пинг-понг паса; стак в центре клетки; FM-Excel |

### Карта и комбо (ядро)

| Ось | Что это | Пример |
|-----|---------|--------|
| **Позиция** | любая клетка сетки + зона роли | GK / DEF / MID / WING / FWD |
...
Матч: пас/навес/отбор/перехват/удар/сейв; мяч летит; пауза на момент.

| Число | Значение |
|-------|----------|
| Формат | **6v6**; колода 18; витрина 3; скамейка 7; merge 3→★; ролл равномерно |
